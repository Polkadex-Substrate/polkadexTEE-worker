...
// use crate::polkaPolkadexRpcGateway;
//
// /// Tests to be performed
// /// Deposit balance is low than amount to be traded
// /// Different Asset id
// ///
// pub fn test_less_balance_deposited() {
...
//
//     //
//     let polkadex_rpc_object = PolkadexRpcGateway{};
//     polkadex_rpc_object.
//
//     // //Initialize Balance
...
//     // //Check Balance
//     // assert_eq!(
//     //     check_balance(UNIT, 0u128, alice.clone(), token_a),
//     //     Ok(())
//     // );
//     //
//     // assert_eq!(
//     //     check_balance(UNIT, 0u128, bob.clone(), token_b),
//     //     Ok(())
//     // );
//     //
