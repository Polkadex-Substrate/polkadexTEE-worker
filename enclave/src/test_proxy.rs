...
fn get_dummy_map() -> HashMap<[u8;32],Vec<[u8;32]>>{
    let mut hashmap: HashMap<[u8;32],Vec<[u8;32]>> = HashMap::new();
    let vec = vec![2,3,4];
    let main_account_one:[u8;32]  = Vec::from("first_account").encode().blake2_256();
    let main_account_two:[u8;32]  = Vec::from("second_account").encode().blake2_256();
    let main_account_three:[u8;32]  = Vec::from("third_account").encode().blake2_256();
    let dummy_account_one:[u8;32]  = Vec::from("first_dummy_account").encode().blake2_256();
    let dummy_account_two:[u8;32]  = Vec::from("second_dummy_account").encode().blake2_256();
    let dummy_account_three:[u8;32]  = Vec::from("third_dummy_account").encode().blake2_256();
...
fn pointer_initialize() -> sgx_status_t{
...
#[allow(unused)]
fn test_check_main_account() {
    pointer_initialize();
    let account_to_find_real:[u8;32]  = Vec::from("first_account").encode().blake2_256();
    let account_to_find_false:[u8;32]  = Vec::from("false_account").encode().blake2_256();
    assert_eq!(polkadex::check_main_account(account_to_find_real), Ok(true));
    assert_eq!(polkadex::check_main_account(account_to_find_fake), Ok(false));
}

#[allow(unused)]
fn test_check_proxy_account() {
    pointer_initialize();
    let main_account:[u8;32]  = Vec::from("first_account").encode().blake2_256();
    let main_account_false:[u8;32]  = Vec::from("false_account").encode().blake2_256();
    let dummy_account_one:[u8;32]  = Vec::from("first_dummy_account").encode().blake2_256();
    let dummy_account_false:[u8;32]  = Vec::from("false_dummy_account").encode().blake2_256();
...
#[allow(unsued)]
fn test_add_main_account() {
    pointer_initialize();
    let main_account:[u8;32]  = Vec::from("new_account").encode().blake2_256();
...
fn test_add_proxy_account() {
    pointer_initialize();
    let main_account:[u8;32]  = Vec::from("first_account").encode().blake2_256();
    let new_proxy_account:[u8;32]  = Vec::from("new_account").encode().blake2_256();
