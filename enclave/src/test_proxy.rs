...
pub fn test_check_if_main_account_registered() {
    ...
    assert_eq!(polkadex::check_if_main_account_registered(account_to_find_real), Ok(true));
    assert_eq!(
...
pub fn test_check_if_proxy_registered() {
    ...
    assert_eq!(
        polkadex::check_if_proxy_registered(main_account, dummy_account_false),
        Ok(false)
    );
    assert_eq!(
...
pub fn test_add_main_account() {
    ...
    assert_eq!(polkadex::check_if_main_account_registered(main_account), Ok(true));
}
...
pub fn test_remove_main_account() {
    ...
    assert_eq!(polkadex::check_if_main_account_registered(main_account), Ok(false));
}
