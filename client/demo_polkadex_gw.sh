...
$CLIENT trusted place_order //AliceIncognito //AliceIncognitoProxy \
 --marketid=btcusd --markettype=trusted --ordertype=limit --orderside=ask --quantity=987345 \
 --mrenclave $MRENCLAVE --direct

echo -n "Get balance of Alice"
$CLIENT trusted get_balance //AliceIncognito --tokenid=btc --mrenclave $MRENCLAVE

echo "Cancel order"
$CLIENT trusted cancel_order //AliceIncognito //AliceIncognitoProxy \
 --marketid=btcusd --markettype=trusted --ordertype=limit --orderside=ask --quantity=987345 \
 --mrenclave $MRENCLAVE --direct

echo "Withdraw"
$CLIENT trusted withdraw //AliceIncognito //AliceIncognitoProxy --tokenid=btc --quantity=293 \
 --mrenclave $MRENCLAVE